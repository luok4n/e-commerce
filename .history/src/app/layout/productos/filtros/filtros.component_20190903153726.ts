...
export class FiltrosComponent implements OnInit {
  ...
  onChanges(): void {
    this.filtrosForm.valueChanges.subscribe(val => {
      if ((this.filtrosForm.value.precio1 > this.filtrosForm.value.precio2) && (this.filtrosForm.value.precio2 !== 0)) {
        let auxiliar: any;
        auxiliar = this.filtrosForm.value.precio2;
        this.filtrosForm.controls.precio2.setValue(this.filtrosForm.value.precio1);
        this.filtrosForm.controls.precio1.setValue(auxiliar);
        console.log('si');
      }
