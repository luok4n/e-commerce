...
export class FiltrosComponent implements OnInit {
  ...
  verificarFiltro(producto, idSubnivel, disponible, precio1, precio2, stock, index) {
    ...
    if (disponible === '') {
      if ((producto.subnivelId === idSubnivel) && (producto.precio > precio1) && (producto.precio < precio2) &&
      ...
      if (producto.precio > precio1) {
        console.log(true);
      }
      if ((producto.subnivelId === idSubnivel) && (producto.disponible === estado) && (producto.precio > precio1) &&
