...
export class ModalComponent implements OnInit {
  ...
  guardarProducto() {
    ...
    if (this.cantidadForm.value.cantidad > this.producto.cantidad) {
      ...
      this.carrito[this.carrito.length + 1] = {idProducto: this.producto.id, nombre: this.producto.nombre, precio: this.producto.precio,
        cantidad}
    }
  }
}

id: auxiliar[i].id, nombre: auxiliar[i].name, precio: auxiliar[i].price, cantidad: auxiliar[i].quantity,
