...
var CheckDirective = /** @class */ (function () {
    function CheckDirective(treeView, zone) {
        ...
        this.subscriptions.add(this.treeView.childrenLoaded
            .pipe(operators_1.filter(function () { return _this.options.checkChildren; }), operators_1.switchMap(function (e) { return _this.zone.onStable.pipe(operators_1.take(1), operators_1.map(function () { return e; })); }))
